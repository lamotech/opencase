...
/**
 * Read-only mapper for the opencase_contactroles lookup table.
 *
 ...
 */
class ContactRoleMapper {

    public function __construct(private IDBConnection $db) {}

    /**
     * Return all roles for the given language as [['id' => int, 'name' => string], ...].
     *
     * @return array[]
     */
