...
/**
 * UserWrapper - Wrapper for the User SOAP service
 *
 * This class handles communication with the User service using
 ...
 */
class UserWrapper extends ServiceplatformenWrapper
{
    private const SOAP_ACTION = 'http://kombit.dk/sts/organisation/bruger/laes';
    ...
    private function extractLaesOutput(string $soapResponse): string
    {
        ...
        $xpath->registerNamespace('ns6', 'http://stoettesystemerne.dk/organisation/bruger/6/');
