...
class SAMLToken
{
    ...
    /**
     * Parse the Lifetime field into a UTC expiration timestamp.
     *
     * The STS returns Lifetime as "m/d/Y H:i:s" (e.g. "07/26/2026 17:14:39"),
     * which is the token's expiration time in UTC.
     *
     * @return \DateTimeImmutable|null Null if the lifetime is missing/unparsable
     */
    public function getExpiresAt(): ?\DateTimeImmutable
    {
        ...
        $expiresAt = \DateTimeImmutable::createFromFormat('m/d/Y H:i:s', $this->lifetime, new \DateTimeZone('UTC'));

        return $expiresAt !== false ? $expiresAt : null;
    }
