...
/**
 * AddressWrapper - Wrapper for the Address SOAP service
 *
 * This class handles communication with the Address service using
 ...
 */
class AddressWrapper extends ServiceplatformenWrapper
{
    private const SOAP_ACTION = 'http://kombit.dk/sts/organisation/adresse/laes';
    ...
    private function extractLaesOutput(string $soapResponse): string
    {
        ...
        $xpath->registerNamespace('ns6', 'http://stoettesystemerne.dk/organisation/adresse/6/');
