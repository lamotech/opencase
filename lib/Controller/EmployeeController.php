...
class EmployeeController extends ApiController {
     ...
     */
    #[NoAdminRequired]
    #[ApiRoute(verb: 'GET', url: '/api/v1/employees/{username}/grants')]
    public function userGrants(string $username): DataResponse {
        $rows   = $this->caseUserMapper->findGrantedCasesByUserId($username);
    ...
    public function search(): DataResponse {
        ...
        $detailQb->select(['uuid', 'username', 'personname', 'email', 'phone', 'location'])
