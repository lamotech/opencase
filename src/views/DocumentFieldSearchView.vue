		...
		<div class="ocfs-docs__form">
			<div class="ocfs-docs__form-grid">
				<div class="ocfs-docs__field">
					<label class="ocfs-docs__label">{{ t('opencase', 'Søgetekst') }}</label>
					<NcTextField v-model="form.title"
						:placeholder="t('opencase', 'Dokumentnummer eller titel…')"
...
export default {
	...
	computed: {
		...
		documentTypeOptions() {
			return this.documentTypes.map(ty => ({ id: ty.name, label: ty.name }))
		},
