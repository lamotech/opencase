...
A companion [JSON schema](./api/public-api.schema.json) gives the exact
JSON Schema for every request body and response shown below;
...
XML instead [XML schema](./api/case-export.xsd),
...
[JSON schema](./api/public-api.schema.json){ .md-button .md-button--primary }
[XML schema](./api/case-export.xsd){ .md-button .md-button--primary }
